...
This is the full Claude Code guide. For the lightweight entrypoint, see `../../CLAUDE.md`.
...
│
├── CLAUDE.md                        # Claude Code quick index (full guide: docs/claude/CLAUDE_FULL.md)
├── docs/                            # Documentation
│   └── claude/
│       └── CLAUDE_FULL.md           # Full Claude Code guide
...
- `docs/CONTRIBUTING.md` — Contribution guidelines, PR process, CI/CD pipeline
...
1. Start with `CLAUDE.md` (repo root) for quick navigation, then read `docs/claude/CLAUDE_FULL.md` (this file) for details
2. Check `docs/architecture/architecture.md` for system design deep-dive
3. Refer to `docs/CONTRIBUTING.md` for contribution workflow
4. Use `docs/architecture/api-reference.md` when working with specific endpoints
...
| `docs/claude/CLAUDE_FULL.md` | This documentation |
