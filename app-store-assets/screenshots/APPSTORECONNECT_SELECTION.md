# App Store Connect screenshot selection — Astronova
...
3. `03_painpoint.png` <- `screenshot-7-self-tab.png` — Know Your Inner Topology / See active planets, energy, and self patterns.
4. `04_benefit.png` <- `screenshot-6-oracle.png` — Ask the Oracle / Focused guidance when you need a second signal.
5. `05_trust.png` <- `screenshot-2-temple-muhurat.png` — Find Auspicious Timing / Muhurat windows and rituals in one quiet place.
6. `06_cta.png` <- `screenshot-3-temple-astrologers.png` — Meet Vedic Guides / Explore astrologers and temple services with context.
