...
class TestChartGenerationPerformance:
    ...
    def test_chart_generation_latency(self, client, valid_chart_data, benchmark):
        ...
        def generate_chart():
            response = client.post("/api/v1/chart/generate", json=valid_chart_data)
    ...
    def test_chart_aspects_calculation_latency(self, client, valid_chart_data, benchmark):
        ...
        def calculate_aspects():
            response = client.post("/api/v1/chart/aspects", json=valid_chart_data)
            assert response.status_code == 200
            return response.get_json()
...
class TestDatabasePerformance:
    ...
    def test_user_reports_query_latency(self, client, benchmark):
        ...
        def query_user_reports():
            response = client.get("/api/v1/reports/user/perf-test-user")
            assert response.status_code == 200
            return response.get_json()
    ...
    def test_subscription_status_query_latency(self, client, benchmark):
        ...
        def query_subscription():
            response = client.get("/api/v1/subscription/status?userId=perf-test-user")
            assert response.status_code == 200
            return response.get_json()
...
class TestConcurrentRequestHandling:
    ...
    def test_concurrent_horoscope_requests(self, client):
    ...
    def test_concurrent_chart_generation(self, client):
        ...
        def generate_chart(index):
            response = client.post("/api/v1/chart/generate", json=chart_data)
            return response.status_code, response.get_json()
    ...
    def test_concurrent_dasha_calculations(self, client):
...
class TestLargePayloadHandling:
    ...
    def test_max_birth_data_size(self, client):
        ...
        response = client.post("/api/v1/chart/generate", json=large_birth_data)

        # Should handle gracefully (either succeed or return proper error)
        assert response.status_code in [200, 400, 413]

    def test_many_concurrent_reports_query(self, client):
        ...
        # Query all reports
        start_time = datetime.now()
        response = client.get("/api/v1/reports/user/heavy-user")
        elapsed_time = (datetime.now() - start_time).total_seconds()
...
class TestMemoryLeakDetection:
    ...
    def test_repeated_horoscope_calls_no_leak(self, client):
    ...
    def test_repeated_dasha_calls_no_leak(self, client):
...
class TestEphemerisPerformance:
    ...
    def test_current_positions_latency(self, client, benchmark):
        ...
        def get_positions():
            response = client.get("/api/v1/ephemeris/current")
            assert response.status_code == 200
            return response.get_json()
    ...
    def test_positions_at_date_latency(self, client, benchmark):
        ...
        def get_positions_at_date():
            response = client.get("/api/v1/ephemeris/at?date=2025-01-01")
            assert response.status_code == 200
            return response.get_json()
...
class TestAuthenticationPerformance:
    ...
    def test_apple_auth_latency(self, client, benchmark):
        ...
        def authenticate():
            response = client.post("/api/v1/auth/apple", json={"userIdentifier": "perf-test-user", "email": "perf@test.com"})
            assert response.status_code == 200
            return response.get_json()
...
class TestLocationSearchPerformance:
    ...
    def test_location_search_latency(self, client, benchmark):
        ...
        def search_location():
            response = client.get("/api/v1/location/search?q=Mumbai&limit=5")
            assert response.status_code == 200
            return response.get_json()
