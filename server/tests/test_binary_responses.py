...
class TestPDFEndpoints:
    ...
    def test_pdf_content_type_header(self, client):
    ...
    def test_pdf_content_disposition_header(self, client):
    ...
    def test_pdf_response_is_not_json(self, client):
    ...
    def test_pdf_size_reasonable(self, client):
    ...
    def test_pdf_invalid_report_id_returns_404(self, client):
        """Test invalid report IDs return 404, not broken PDF."""
        invalid_report_id = "nonexistent-report-12345"

        response = client.get(f"/api/v1/reports/{invalid_report_id}/pdf")
    ...
    def test_pdf_contains_report_content(self, client):
    ...
    def test_pdf_multiple_report_types(self, client):
    ...
    def test_pdf_content_length_header(self, client):
...
class TestBinaryResponseHeaders:
    ...
    def test_error_responses_are_json_not_binary(self, client):
    ...
    def test_json_endpoints_return_json_content_type(self, client):
        ...
        response = client.get("/api/v1/horoscope/daily?sign=aries&date=2025-01-01")
        assert response.status_code == 200
        assert "application/json" in response.content_type

    def test_response_has_no_transfer_encoding_chunked_for_small_files(self, client):
...
class TestContentEncoding:
    ...
    def test_gzip_compression_support(self, client):
...
class TestBinaryDataIntegrity:
    ...
    def test_pdf_binary_data_not_corrupted(self, client):
        ...
        response1 = client.get(f"/api/v1/reports/{report_id}/pdf")
        response2 = client.get(f"/api/v1/reports/{report_id}/pdf")
    ...
    def test_pdf_no_text_encoding_corruption(self, client):
...
class TestReportAliasRedirect:
    ...
    def test_singular_report_redirects_to_plural(self, client):
    ...
    def test_singular_report_pdf_redirects(self, client):
        ...
        response = client.get(f"/api/v1/report/{report_id}/pdf", follow_redirects=False)
    ...
    def test_redirect_preserves_pdf_content_type(self, client):
        ...
        response = client.get(f"/api/v1/report/{report_id}/pdf", follow_redirects=True)
...
class TestCacheHeaders:
    ...
    def test_pdf_cache_headers(self, client):
