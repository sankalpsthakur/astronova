...
def create_app():
    ...
    # Use the network address at this pre-auth boundary. X-User-Id is a
    # compatibility header, not an authenticated identity, and must not be a
    # throttle key.
    def get_key():
    ...
    app.extensions["astronova_limiter"] = limiter
